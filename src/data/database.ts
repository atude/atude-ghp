...
const database: Database = {
	...
	Toolset: {
		...
		Backend: ["Node", "GraphQL", "Express", "AWS CDK"],
		Cloud: [
			"AWS Lambda",
			"AWS API Gateway",
			"AWS DynamoDB",
		...
		Devops: ["AWS CodePipeline", "CircleCI", "GitLab CI", "Fastlane", "Vercel"],
	...
	Experience: [
		...
		},
		{
			...
			role: "Software Engineer • AWS Professional Services",
			color: "#d98507",
			colorDark: "#e8ae56",
			year: "MAR 2021",
			tools: ["AWS", "TypeScript", "React", "Node"],
			description:
				"At AWS ProServe, I built an internal cloud native, event-driven app that would collate multiple pipelines into a dashboard for an admin to track projects across multiple teams. Additionally, I modernised an outdated SOAP API into a multi-project node app that is RESTful, serverless and scalable with automated building, testing and deployment on AWS services, as well as creating its infrastructure using AWS CDK (Infrastructure as Code).",
		},
		{
			company: "Zip",
			role: "Software Engineer • New Markets",
			color: "#1A0826",
			colorDark: "#A58BF7",
			year: "OCT 2020",
			tools: [
		...
		{
			company: "ConsenSys",
			role: "Software Engineer • Impactio",
			color: "#2C56DD",
			colorDark: "#8096e0",
			year: "SEP 2019",
