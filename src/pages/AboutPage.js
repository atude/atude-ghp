  ...
  return (
    <Fade in timeout={600}>
      <div className="ParentCenterContainer">
        ...
        style={{overflow: transitionDone ? "inherit" : "hidden"}}>
        ...
        <Grid item lg={10} md={10} sm={10} xs={12}>
          <Slide in timeout={tBase+tAdd*1} direction="up" onEntered={() => setTransitionDone(true)}>
          <ContentCard mainColor={mainColor} currentScheme={currentScheme}
        ...
        <Grid item lg={10} md={10} sm={10} xs={12}>
          <Slide in timeout={tBase+tAdd*2} direction="up" onEntered={() => setTransitionDone(true)}>
          <ContentCard mainColor={mainColor} currentScheme={currentScheme}
