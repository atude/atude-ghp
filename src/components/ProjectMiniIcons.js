  ...
  types.forEach(item => {
    switch (item) {
      ...
      case "Jest":
        iconList.push(
          <Tooltip disableFocusListener title={item}>
            <SvgIcon fontSize="small" viewBox="-25 -25 306 323" style={miniIconColor}>
